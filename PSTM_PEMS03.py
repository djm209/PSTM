...
from .pstm_arch import STEP
from .pstm_runner import STEPRunner
from .pstm_loss import step_loss
from .pstm_data import ForecastingDataset
...
CFG.GPU_NUM = 1
CFG.NUM_TOKENS = 288 * 7 / 12
CFG.H_ORDER = 2
CFG.BASE_T = 24

adj_mx, _ = load_adj("F:/djm/STEP-github_new/STEP-github/datasets/PEMS03/adj_mx.pkl", "doubletransition")
...
CFG.MODEL.PARAM = {
    ...
    "pre_trained_tsformer_path": "../tsformer_ckpt/TSFormer_best_val_MAE.pt",
    "tsformer_args": {
                    "patch_size":12,
                    "in_channel":1,
                    "embed_dim":96,
